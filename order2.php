...
if(isset($_SESSION['uname']))
{
    ...
    VALUES ('Classic Cold Koffee', '1', '150','$user')";
    if (mysqli_query($conn, $sql1)) {
        echo "<script type='text/javascript'>alert('Classic Cold Koffee is waiting for you in the cart.'); window.location.href='home.php'</script>";
    }
    else {
