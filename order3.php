...
if(isset($_SESSION['uname']))
{
    ...
    VALUES ('Ice Cream Oreo', '1', '150','$user')";
    if (mysqli_query($conn, $sql1)) {
        echo "<script type='text/javascript'>alert('Ice Cream Oreo is waiting for you in the cart.'); window.location.href='home.php'</script>";
    }
    else {
