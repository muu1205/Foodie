...
if(isset($_SESSION['uname']))
{
    ...
    VALUES ('English Breakfast', '1', '399','$user')";
    if (mysqli_query($conn, $sql1)) {
        echo "<script type='text/javascript'>alert('English Breakfast is waiting for you in the cart.'); window.location.href='home.php'</script>";
    }
    else {
