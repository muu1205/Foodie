...
if(isset($_SESSION['uname']))
{
    ...
    VALUES ('Indian Breakfast', '1', '349','$user')";
    if (mysqli_query($conn, $sql1)) {
        echo "<script type='text/javascript'>alert('Indian Breakfast is waiting for you in the cart.'); window.location.href='home.php'</script>";
    }
    else {
