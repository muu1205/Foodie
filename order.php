...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title><?php echo $_SESSION["uname"]."'s "?>Orders</title>
    ...
    <body>
        ...
        <br><br>
         <div>
             <br>
             <div align="center"><span id="order">My Orders till today...</span></div>
            <section>
                        ...
                        <?php
                            ...
                            <?php if ($result->num_rows > 0){
                                while($row = $result->fetch_assoc()) {
                                    echo "<tr><td>".$row['datee']."</td><td>".$row['item']."</td><td>".$row['total']."</td></tr>";
                                }
                            }
                             else {
