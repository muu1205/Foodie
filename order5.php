...
if(isset($_SESSION['uname']))
{
    ...
    VALUES ('Barbecued Prawns', '1', '699','$user')";
    if (mysqli_query($conn, $sql1)) {
        echo "<script type='text/javascript'>alert('Barbecued Prawns is waiting for you in the cart.'); window.location.href='home.php'</script>";
    }
    else {
